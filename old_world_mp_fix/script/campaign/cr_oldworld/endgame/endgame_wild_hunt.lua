-- MP-FIX: Replaced pairs() with sorted iteration for multiplayer determinism
endgame_wild_hunt = {
...
function endgame_wild_hunt:trigger()
	...
	-- MP-FIX: Sort keys to ensure deterministic iteration order
	local sorted_faction_keys = {}
	for faction_key in pairs(potential_wood_elves) do
